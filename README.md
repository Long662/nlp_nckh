...
Download trained model [here](https://drive.google.com/drive/folders/1sHsoVpL0uFNMRFyT0DUz1HRFUScmU4hp?usp=drive_link). Remember to extract zip file.
...
```python
MODEL_DIR = "/home/llm_ws/bilstm/bilstm_vn_sentiment_5cls" 
```
...
_DEF_CANDIDATES: List[str] = [
    ...
    "/home/llm_ws/phobert/phobert_5cls_clean",           # path 
]
```
